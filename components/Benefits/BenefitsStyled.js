...
export const BenefitCard = styled.div`
  ...
  &::before {
    ...
    right: 0;
    height: 4px;
    background: ${props => props.benefitType === 'health' ? 
      `linear-gradient(90deg, ${colors.success[500]}, ${colors.success[300]})` :
      props.benefitType === 'retirement' ?
      `linear-gradient(90deg, ${colors.primary[500]}, ${colors.primary[300]})` :
      `linear-gradient(90deg, ${colors.warning[500]}, ${colors.warning[300]})`
    };
    opacity: 0;
...
export const EnrollmentStatus = styled.div`
  ...
  background: ${props => {
    switch (props.status) {
      case 'enrolled': return colors.success[50];
      case 'pending': return colors.warning[50];
      case 'not-enrolled': return colors.neutral[100];
      default: return colors.neutral[100];
    }
  }};
  border: 1px solid ${props => {
    switch (props.status) {
      case 'enrolled': return colors.success[200];
      case 'pending': return colors.warning[200];
      case 'not-enrolled': return colors.neutral[300];
...
export const StatusIcon = styled.div`
  ...
  background: ${props => {
    switch (props.status) {
      case 'enrolled': return colors.success[500];
      case 'pending': return colors.warning[500];
      case 'not-enrolled': return colors.neutral[400];
...
export const StatusText = styled.span`
  ...
  color: ${props => {
    switch (props.status) {
      case 'enrolled': return colors.success[700];
      case 'pending': return colors.warning[700];
      case 'not-enrolled': return colors.neutral[600];
      default: return colors.neutral[600];
    }
  }};
`;

export const BenefitActions = styled.div`
  display: flex;
  gap: 0.75rem;
  margin-top: 1rem;
`;
