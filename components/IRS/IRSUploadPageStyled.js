// This file is no longer needed as we're using MainDashboardStyled.js
// All styling is now handled by the styled components in IRSUploadPage.js
...
//   ? 'linear-gradient(rgba(0, 0, 0, 0.85), rgba(0, 0, 0, 0.85)), url("https://eagleeyecollection.com/wp-content/uploads/2021/07/hero-eagle-eye-1568x1045.jpg")' 
//   : 'linear-gradient(rgba(255, 255, 255, 0.9), rgba(255, 255, 255, 0.9)), url("https://eagleeyecollection.com/wp-content/uploads/2021/07/hero-eagle-eye-1568x1045.jpg")'};
...
export const Button = styled.button`
  ...
  ${props => props.variant === 'secondary' && `
    background-color: ${props.isDarkMode ? 'rgba(255, 255, 255, 0.1)' : 'white'};
    color: ${props.isDarkMode ? '#cbd5e0' : '#4a5568'};
    border: 1px solid ${props.isDarkMode ? '#4a5568' : '#e2e8f0'};
    
    &:hover {
      background-color: ${props.isDarkMode ? 'rgba(255, 255, 255, 0.15)' : '#f7fafc'};
    }
  `}
`;
...
export const ReportsTable = styled.table`
  ...
  th {
    ...
    top: 0;
    z-index: 10;
    background: ${props => props.isDarkMode ? '#111827' : '#f8fafc'};
    color: ${props => props.isDarkMode ? '#e5e7eb' : '#1a202c'};
    padding: 1rem 1.5rem;
    text-align: left;
    font-size: 0.875rem;
    font-weight: 600;
...
export const DarkModeToggle = styled.button`
  ...
  &:hover {
    background-color: ${props => props.isDarkMode ? '#e2e8f0' : '#333'};
  }
`;
...
export const ProgressBar = styled.div`
  ...
  .progress-fill {
    ...
    box-shadow: 0 0 10px rgba(255, 132, 11, 0.3);
  }
`;

export const FilePreview = styled.div`
  background: ${props => props.isDarkMode ? 'rgba(255, 255, 255, 0.05)' : '#f8fafc'};
  border-radius: 8px;
  padding: 1rem;
  margin: 1rem 0;
  display: flex;
  ...
  .remove-button {
    ...
    &:hover {
      background: ${props => props.isDarkMode ? 'rgba(255, 255, 255, 0.1)' : '#f1f5f9'};
      color: #ef4444;
    }
  }
`;
...
export const StatusBadge = styled.span`
  ...
  ${props => {
    switch (props.status) {
      case 'success':
        return `
          background: ${props.isDarkMode ? 'rgba(34, 197, 94, 0.1)' : '#f0fdf4'};
          color: ${props.isDarkMode ? '#86efac' : '#16a34a'};
          border: 1px solid ${props.isDarkMode ? 'rgba(34, 197, 94, 0.2)' : '#dcfce7'};
        `;
      case 'error':
        return `
          background: ${props.isDarkMode ? 'rgba(239, 68, 68, 0.1)' : '#fef2f2'};
          color: ${props.isDarkMode ? '#fca5a5' : '#dc2626'};
          border: 1px solid ${props.isDarkMode ? 'rgba(239, 68, 68, 0.2)' : '#fee2e2'};
        `;
      case 'warning':
        return `
          background: ${props.isDarkMode ? 'rgba(234, 179, 8, 0.1)' : '#fefce8'};
          color: ${props.isDarkMode ? '#fde047' : '#ca8a04'};
          border: 1px solid ${props.isDarkMode ? 'rgba(234, 179, 8, 0.2)' : '#fef9c3'};
        `;
      default:
        return `
          background: ${props.isDarkMode ? 'rgba(99, 102, 241, 0.1)' : '#f5f3ff'};
          color: ${props.isDarkMode ? '#a5b4fc' : '#6366f1'};
          border: 1px solid ${props.isDarkMode ? 'rgba(99, 102, 241, 0.2)' : '#ede9fe'};
        `;
    }
  }}
`;
...
export const Tooltip = styled.div`
  ...
  .tooltip-content {
    ...
    &::before {
      ...
      border-top-color: ${props => props.isDarkMode ? '#333' : '#e2e8f0'};
    }
    ...
    &::after {
      ...
      border-top-color: ${props => props.isDarkMode ? '#1a1a1a' : '#ffffff'};
    }
  }
`;

export const AnimatedCheckmark = styled.div`
  width: 24px;
  height: 24px;
  border-radius: 50%;
  background: ${props => props.isDarkMode ? '#22c55e' : '#22c55e'};
  position: relative;
  display: flex;
  align-items: center;
  justify-content: center;
  ...
  &::before {
    ...
    position: absolute;
    animation: checkmark 0.2s ease-in-out 0.2s forwards;
    opacity: 0;
  }
...
export const StepperLayout = styled.div`
  ...
  &::before {
    ...
    background: ${props => props.isDarkMode 
      ...
      : 'linear-gradient(145deg, rgba(255, 132, 11, 0.02), rgba(99, 102, 241, 0.02))'};
    border-radius: 24px;
    z-index: -1;
  }
...
export const StepperSidebar = styled.div`
  ...
  border: 1px solid ${props => props.isDarkMode ? '#333' : '#e2e8f0'};
  box-shadow: 0 4px 6px -1px ${props => props.isDarkMode 
    ? 'rgba(0, 0, 0, 0.2)' 
    : 'rgba(0, 0, 0, 0.1)'};
  ...
  &:hover {
    transform: translateY(-2px);
    box-shadow: 0 8px 12px -1px ${props => props.isDarkMode 
      ? 'rgba(0, 0, 0, 0.3)' 
      : 'rgba(0, 0, 0, 0.15)'};
  }
...
export const StepperStep = styled.div`
  ...
  &:hover .step-number::after {
    border-color: ${props => props.isDarkMode ? 'rgba(255, 132, 11, 0.3)' : 'rgba(255, 132, 11, 0.2)'};
    transform: scale(1.1);
  }
...
`;
export const GlowingAccent = styled.div`
  position: absolute;
  width: 300px;
  height: 300px;
  border-radius: 50%;
...
export const ProgressIndicator = styled.div`
  ...
  &::after {
    ...
    left: 0;
    height: 100%;
    width: ${props => (props.currentStep / 4) * 100}%;
    background: linear-gradient(
      90deg,
      #ff840b,
      #ff9f3f
...
export const UploadZone = styled.div`
  border: 2px dashed ${props => props.dragActive 
    ? '#ff840b' 
    : props.isDarkMode ? '#4a5568' : '#e2e8f0'};
  border-radius: 16px;
  padding: 3rem 2rem;
  transition: all 0.3s ease;
  cursor: pointer;
...
export const TableWrapper = styled.div`
  ...
  &::-webkit-scrollbar-thumb {
    background: ${props => props.isDarkMode ? '#333' : '#888'};
    border-radius: 4px;
    
    &:hover {
      background: ${props => props.isDarkMode ? '#444' : '#555'};
    }
  }
...
export const RequestAccessButton = styled.button`
  ...
  font-size: 1rem;
  transition: all 0.3s ease;
  box-shadow: 0 0 0 rgba(255, 132, 11, 0);
  
  &:hover {
    background: linear-gradient(145deg, #ff840b, #ff9f3f);
    transform: scale(1.05);
    box-shadow: 0 0 20px rgba(255, 132, 11, 0.5);
  }
`;
