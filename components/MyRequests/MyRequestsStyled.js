...
export const UploadModalContent = styled.div`
  ...
  border: 1px solid ${props => props.isDarkMode ? '#1a1a1a' : '#e5e7eb'};
  ...
  .modal-header {
    ...
    margin-bottom: 2rem;
    padding-bottom: 1rem;
    border-bottom: 2px solid ${props => props.isDarkMode ? '#374151' : '#e5e7eb'};
  ...
  .form-footer {
    ...
    margin-top: 2rem;
    padding-top: 1.5rem;
    border-top: 2px solid ${props => props.isDarkMode ? '#374151' : '#e5e7eb'};
  ...
  &::-webkit-scrollbar-track {
    background: ${props => props.isDarkMode ? '#111827' : '#f3f4f6'};
    border-radius: 4px;
  }

  &::-webkit-scrollbar-thumb {
    background: ${props => props.isDarkMode ? '#374151' : '#d1d5db'};
    border-radius: 4px;
